...
#check if the string 'Gab3d-Klipper-Utilities' exists in the file /home/pi/printer_data/moonraker.asvc if not append it
if grep -q 'Gab3d-Klipper-Utilities' /home/pi/printer_data/moonraker.asvc; then
  echo "Gab3d-Klipper-Utilities already exists in /home/pi/printer_data/moonraker.asvc"
else
  echo "Gab3d-Klipper-Utilities does not exist in /home/pi/printer_data/moonraker.asvc, adding it now"
  echo "Gab3d-Klipper-Utilities" >> /home/pi/printer_data/moonraker.asvc
fi
